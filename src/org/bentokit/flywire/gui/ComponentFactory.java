...
public class ComponentFactory {
     ...
     * @return
     */
    public static JButton createButton(String label, String tip, ActionListener listener, int width, int max_width) {
        ...
        tmp.setMaximumSize(new Dimension(max_width < 1 ? Short.MAX_VALUE : max_width, Short.MAX_VALUE));
        if (listener != null) {
     ...
     * @return
     */
    public static JCheckBox createCheck(boolean value, String label, String tip, int width, int max_width) {
     ...
     * @return
     */
    public static JComboBox createCombo(String[] choices, int index, String tip, int width, int max_width) {
     ...
     * @return
     */
    public static JComboBox createCombo(String[] choices, String text, String tip, int width, int max_width) {
        JComboBox tmp = new JComboBox(choices);
     ...
     * @return
     */
    public static JComboBox createCombo(String[] choices, String[] choices2, String index, String tip, int width, int max_width) {
        JComboBox tmp = new JComboBox(choices);
     ...
     * @return
     */
    public static JComboBox createCombo(DefaultComboBoxModel model, int index, String tip, int width, int max_width) {
     ...
     * @return
     */
    public static JPanel createFourPanel(Component obj1, Component obj2, Component obj3, Component obj4) {
     ...
     * @return
     */
    public static JTextField createInput(String value, String tip, int width, int max_width) {
        ...
        tmp.setMaximumSize(new Dimension(max_width < 1 ? Short.MAX_VALUE : max_width, (int) tmp.getPreferredSize().getHeight()));
        return tmp;
    }
     ...
     * @return
     */
    public static JTextField createInput(String value, String tip, ActionListener listener, int width, int max_width) {
     ...
     * @return
     */
    public static JLabel createLabel(String label, String tip, int width, int max_width) {
     ...
     * @return
     */
    public static JPanel createThreePanel(Component leftObject, Component centerObject, Component rightObject) {
        JPanel tmp = new JPanel();
        tmp.setLayout(ComponentFactory.createBorderLayout(5, 5));
     ...
     * @return
     */
    public static JPanel createTwoPanel(Component leftObject, Component centerObject) {
        JPanel tmp = new JPanel();
        tmp.setLayout(ComponentFactory.createBorderLayout(5, 5));
        tmp.add(leftObject, BorderLayout.WEST);
        tmp.add(centerObject, BorderLayout.CENTER);
     ...
     * @return
     */
    public static JPanel createTwoPanelEq(Component leftObject, Component centerObject) {
        JPanel tmp = new JPanel();
        tmp.setLayout(ComponentFactory.createBorderLayout(5, 5));
        tmp.add(leftObject, BorderLayout.WEST);
