...
;!define AppName "Flywire" ;Now passed from ant script.
...
; Specify Java version required
!define JRE_VERSION "1.6"
!define JRE_URL "http://javadl.sun.com/webapps/download/AutoDL?BundleId=33787"

; Specify JMF version required
!define JMF_VERSION "2.1.1e"

;--------------------------------
;Include Java Installer

!include "JREInstaller/JREDyna.nsh"

;--------------------------------
;Include Java Media Framework Installer

!include "JMFInstaller/JMFDyna.nsh"
...
; The file to write
OutFile "${DestDir}/Flywire-${RELEASETYPE}-Windows-x86-${VERSION}.exe"
...
; INSTALL PAGES
  ...
  ; Notify the user we're installing Java, if necessary
  !insertmacro CUSTOM_PAGE_JREINFO

  ; Notify the user we're installing the Java Media Framework, if necessary
  !insertmacro CUSTOM_PAGE_JMFINFO
...
Section "Flywire (required)"
  ...
  ; Install Java Media Framework, if necessary
  call DownloadAndInstallJMFIfNecessary
  ...
  File /r "jspiff-1.0.jar"
  File /r "libkrispi.jar"
